...
const Editdetails = () => {
  ...
  const [description, setDescription] = useState({
    ...
    useEffect(() => {
        if (id) {
          axios.get(`http://localhost:3000/Home/getHome/${id}`)
            .then(result => {
                ...
                setDescription({
                    rooms:data.description.rooms,
                    BedRoom:data.description.BedRoom,
                    Wifi:data.description.Wifi,
                    Parking:data.description.Parking,
                    Laundry:data.description.Laundry
                })
            })
            .catch(err => {
      ...
      const handlePatch=(e)=>{
        e.preventDefault()
          axios.put(`http://localhost:3000/Home/updateHome/${id}`,{
            name:name,
            price:price,
  ...
  return (
    ...
    <form  onSubmit={handlePatch}className="register-form">
      <div className="mb-4">
